######## Webcam Object Detection Using Tensorflow-trained Classifier Modified from EdjeElectronics Code #########
#
...
# If AutoStart crontab add  + "/Desktop/Main"
CWD_PATH = os.getcwd() + "/Desktop/Main"
...
for image_path in images:
    ...
    if show_results:
        cv2.imshow('Object detector', cv2.resize(image,(1080,720)))
        break
